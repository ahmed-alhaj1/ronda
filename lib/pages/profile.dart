...
//import 'package:ronda/widgets/cached_image.dart';
...
class _ProfileState extends State<Profile> {
                                ...
                                Row(
                                  children: [
                                    ...
                                    widget.profileId == currentUserId()
                                        ...
                                        : const Text(
                                            'widget.profile is not curr user')
                                    //: buildLikeButton()
                                  ],
                                ),
                              ],
                        ...
                        children: [
                          ...
                          IconButton(
                            onPressed: () async {
                              ...
                              print('I am ## profile page ');
                              print(widget.profileId);
                              if (!mounted) {
                                print('somethnig wrong with mounting');
                                return;
                              }
                              Navigator.push(
                                context,
  ...
  buildPostView() {
    print('I am at post view and going to buildPostView() ');
    return buildGridPost();
  }

  buildGridPost() {
    print('I am at grid view GridPost()');
