...
import 'package:ronda/components/custom_card.dart';
import 'package:ronda/components/custom_image.dart';
import 'package:ronda/models/post.dart';
import 'package:ronda/models/user.dart';
import 'package:ronda/pages/profile.dart';
//import 'package:ronda/screens/comment.dart';
//import 'package:ronda/screens/view_image.dart';
import 'package:ronda/screens/view_jobs.dart';
    ...
    return StreamBuilder(
      ...
      builder: (context, AsyncSnapshot<DocumentSnapshot> snapshot) {
        if (snapshot.hasData) {
          ...
          return Container(child: Text('empty snapshot userpost! '));
        }
      },
    );
  }
